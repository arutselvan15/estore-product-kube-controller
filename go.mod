module github.com/arutselvan15/estore-product-kube-controller

require (
	github.com/arutselvan15/estore-common v1.0.9
	github.com/arutselvan15/estore-product-kube-client v1.0.5
